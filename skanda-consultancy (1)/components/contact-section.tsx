      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to transform your business? Contact our expert consultants today for a free consultation.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@skandaconsultancy.com</p>
                    <p className="text-gray-600">support@skandaconsultancy.com</p>
                  </div>
                </div>
